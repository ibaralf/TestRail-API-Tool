...
class Argument
  ...
  USAGE = "Usage: \n  trail_marker.rb -r run_plan_name -p project_name -x /home/aspera/results_xml/ \n"
  HELP = "    -h, Show HELP
    -p *, name of project (e.g. Aspera Files) (required parameter) 
  ...
  REQUIRED = "\nMissing required parameter/s (until config file implemented):
    Ex: trail_marker.rb -p Aspera Files -r sprint_2 -x ./results/path
    -p, name of project (e.g. -p Aspera Files)
    -r or -t, name of test run or test plan (e.g. -r sprint_2)
    -x or -f, path (Directory) or a specific file of results to parse (e.g. -f /home/aspera/results/rspec_res.xml)\n"
